# -----------------------------------------
# アニメーション設定
class He.Openning extends He.Animation
  constructor : ->
    @cls = He.Openning
    @cls.images = [
      './images/bf_sky.png',
...
class MainScene extends Scene
  ...
  updateTxt: (json)->
    ...
    diff = json.me.st - $('#st').text()
    cls = if diff > 0 then 'status_up' else 'status_down'
...
class Charactor extends HeSprite
  ...
  constructor: (num = 1) ->
    ...
    @image = He.game.getAsset('char_' + char)
