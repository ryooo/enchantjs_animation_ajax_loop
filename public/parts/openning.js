(function() {
  ...
  He.Openning = (function(_super) {

    __extends(Openning, _super);

    function Openning() {
      this.cls = He.Openning;
      this.cls.images = ['./images/bf_sky.png', './images/bf1_32.png', './images/12000801.jpg', './images/BG_glow.png', './images/obj2_grp.png', './images/weapon_eff_g1.png', './images/weapon_eff_arrow.png', './images/weapon_eff_g2.png', './images/ground_shadow.png', './images/type_color_green.png', './images/touch_touch.png', './images/dust_anim.png', './images/bg_gradient_g1.png', './images/bg_gradient_g2.png'];
      Openning.__super__.constructor.apply(this, arguments);
    }

    Openning.prototype.startCore = function() {
      He.debug('Openning', 'startCore');
      He.game.pushScene(new MainScene());
      return He.Com.sysMessage('hogehoge');
    };

    Openning.boot = function(apiResult) {
      if (apiResult == null) apiResult = {};
      He.debug('Openning', 'boot');
      return new He.Openning();
    };
  ...
  He.animations.openning.cls = He.Openning;
  ...
  MainScene = (function(_super) {
    ...
    function MainScene(w, h) {
      var center_x;
      MainScene.__super__.constructor.call(this, 100, 50);
      this.i = 0;
  ...
  Charactor = (function(_super) {
    ...
    function Charactor(num) {
      ...
      this.image = He.game.getAsset('char_' + char);
